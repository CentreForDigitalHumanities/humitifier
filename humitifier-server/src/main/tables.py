...
class UsersTable(BaseTable):
    class Meta:
        ...
        no_data_message_wild_wasteland = "It's lonely in here... Where did all the users go?"

    full_name = ValueColumn(
        "Name",
        value_attr='get_full_name'
    )
    ...
    access_profiles = MethodColumn(
        'Access Profiles',
        method_name='get_access_profiles'
    )
