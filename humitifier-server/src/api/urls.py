...
from .views import CreateOAuthApplicationView, DeleteOAuthApplicationView, \
    EditOAuthApplicationView, \
    InventorySync, UploadScans, \
...
urlpatterns = [
    ...
    # OAuth2
    path("oauth/authorize/", oauth_views.AuthorizationView.as_view(),
         name="authorize"),
    ...
    path("oauth/introspect/", oauth_views.IntrospectTokenView.as_view(), name="introspect"),
    path("oauth/applications/", OAuthApplicationsView.as_view(),
        name="oauth_applications"),
    path("oauth/applications/create/", CreateOAuthApplicationView.as_view(),
        name="create_oauth_application"),
    path("oauth/applications/<int:pk>/edit/",
